...
namespace Concentus.Oggfile
{
    ...
    public class OpusOggWriteStream
    {
        ...
        /// writing the output pages to an underlying stream.
        ...
        /// the encoding).</param>
        public OpusOggWriteStream(
            OpusEncoder encoder, Stream outputStream, bool leaveOpen = false, OpusTags fileTags = null, int inputSampleRate = 0)
        {
            _encoder = encoder;
        ...
        /// <summary>
        /// Writes a buffer of PCM audio samples to the encoder and packetizer. Runs Opus encoding and potentially outputs one or more pages to the underlying stream.
        ...
        /// This operation will close the underlying stream
        /// depending on the <see cref="LeaveOpen"/> property.
        /// </summary>
        public void Finish()
        {
